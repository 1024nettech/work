...
async function main() {
        ...
        if (auth[1] === "1") {
            ...
            if (url.includes("mshop/?")) {
                ...
                let html = `
                    ...
                    `;
                publics.addHtmlIfSelectorNotExists(".header-nav #shop-info", html, ".header-nav");
                ...
                publics.addHtmlIfSelectorNotExists(".main .v-x-scroll #tipx", html, ".main .v-x-scroll", onSuccess);
    ...
    else if (url.includes("https://detail.tmall.com/item.htm") || url.includes("https://item.taobao.com/item.htm") || url.includes("https://item.jd.com/")) {
        $(document).on("mouseleave", "body", function () {
            ali.img_rename();
        });
    }
